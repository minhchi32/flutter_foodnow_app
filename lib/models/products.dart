class Products {
  ...
  double price;
  int categoryId;
  Products({required this.id, required this.title, required this.description, required this.image, required this.price, required this.categoryId});
  ...
  static List<Products> init() {
    List<Products> data = [
      ...
      Products(
          ...
          image: "assets/foods/ic_milk_tea.png",
          price: 8.0,
          categoryId: 3),
      Products(
          id: 4,
